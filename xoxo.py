...
def pl1(player1move):
    ...
    while move_status:
        ...
        if player1move in field:
            move_status=False
            if field[player1move] == player2mark:
                print('Поле занято вторым игроком')
                move_status = True
            if field[player1move] == player1mark:
                print('Вы уже заняли это поле!')
                move_status = True
...
def pl2(player2move):
    ...
    while move_status:
        ...
        if player2move in field:
            move_status=False
            if field[player2move] == player1mark:
                print('Поле занято первым игроком')
                move_status = True
            if field[player2move] == player2mark:
                print('Вы уже заняли это поле!')
                move_status = True
        else:
            print('!!!!!!!!!')
